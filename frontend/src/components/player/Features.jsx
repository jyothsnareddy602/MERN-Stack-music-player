    ...
    <div className="features-root">
      <div className="features-row">
        ...
        <button
          ...
          onClick={onToggleMute} // corrected syntax
        >
          {isMuted ? (
        ...
        >
          <TbArrowsShuffle color={shuffleEnabled? "#9ca3af":"#9ca3af"}
           size={26} />
        </button>
        ...
        >
          <RiLoopRightLine 
          color={loopEnabled?"#9ca3af" :"#9ca3af"}
            size={26} />
        </button>
        ...
        <label className="features-speed-label" htmlFor="playbackSpeed">
          <select
            name="playbackSpeed"
            id="playbackSpeed"
            aria-label="playbackSpeed" // corrected attribute
